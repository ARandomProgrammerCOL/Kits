...
public class NetheriteGapple {
    ...
    ItemStack boots;
    ItemStack sword;
    public NetheriteGapple(Player player) {
        ...
        sword = creators.swordCreator3(Material.NETHERITE_SWORD, Enchantment.DAMAGE_ALL, Enchantment.DURABILITY, Enchantment.FIRE_ASPECT, 5, 3, 2);
        ...
        player.getInventory().setItemInOffHand(GApple);
                ...
                Msg.send(player, "&fSe te ha dado el Kit &9Netherite Gapple.");
    }
    public NetheriteGapple(ArmorStand armorStand) {
        helmet = creators.helmetCreator2(Material.NETHERITE_HELMET, Enchantment.PROTECTION_ENVIRONMENTAL, Enchantment.DURABILITY, 4, 3);
